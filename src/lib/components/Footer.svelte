...
<section class="bg-[#f9f9f7] pt-24 pb-12 px-6 border-b border-gray-200" id="book">
  <div class="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
    <div>
      ...
      <a href="#" class="text-gray-400 text-xs hover:text-gray-600 transition-colors">
        Outside Vancouver? Contact us about expansion >
      </a>
    </div>
    ...
    <div class="h-[300px] bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 flex items-center justify-center relative">
        <img src="/generated/image-mobile-cold-plunge-unit-with-ice-and-ste-1765481388480-8.webp" class="h-full w-full object-cover" alt="Mobile Wellness Service" />
  ...
  <div class="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-24">
    <div class="h-[300px] rounded-xl overflow-hidden relative group cursor-pointer">
      <img src="/generated/image-cozy-interior-of-a-wooden-sauna-with-war-1765481378672-4.webp" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Sauna Experience" />
      <div class="absolute inset-0 bg-black/30 p-6 flex items-start">
        <p class="text-white text-lg font-light">Premium sauna.<br>View packages -></p>
      </div>
    </div>

    <div class="h-[300px] rounded-xl overflow-hidden relative group cursor-pointer">
      <img src="/generated/image-person-relaxing-in-a-cold-plunge-tub-out-1765481371301-1.webp" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Cold Plunge" />
      <div class="absolute inset-0 bg-black/30 p-6 flex items-start">
        <p class="text-white text-lg font-light">Cold plunge therapy.<br>Learn benefits -></p>
      </div>
    </div>

    <div class="h-[300px] rounded-xl overflow-hidden relative group cursor-pointer">
      <img src="/generated/image-group-of-crossfit-athletes-relaxing-toge-1765481395549-11.webp" class="w-full h-full object-cover bg-white transition-transform duration-700 group-hover:scale-105" alt="Group Sessions" />
      <div class="absolute inset-0 bg-black/20 p-6 flex items-start">
        <p class="text-white text-lg font-light">Group sessions.<br>Team bookings -></p>
      </div>
    </div>

    <div class="h-[300px] rounded-xl overflow-hidden relative group cursor-pointer">
      <img src="/generated/image-scenic-vancouver-cityscape-with-mountain-1765481383488-6.webp" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Vancouver Service" />
      <div class="absolute inset-0 bg-primary-600/80 p-6 flex items-start">
        <p class="text-white text-lg font-light">Vancouver's only.<br>Service area -></p>
      </div>
    </div>
  </div>
</section>
...
<footer class="bg-[#f9f9f7] pt-12 pb-12 px-6">
  <div class="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
    <div>
      <h3 class="font-medium text-gray-900 mb-4">Nordic Edge</h3>
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm text-gray-500">
        <li><a href="#services" class="hover:text-gray-900">Packages</a></li>
        <li><a href="#book" class="hover:text-gray-900">Book Session</a></li>
        ...
        <li><a href="#" class="hover:text-gray-900">Service Area</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm text-gray-500">
        ...
        <li><a href="tel:+16045550123" class="hover:text-gray-900">(604) 555-0123</a></li>
      </ul>
    </div>

    <div>
      <h3 class="font-medium text-gray-900 mb-4">Stay Updated</h3>
      <p class="text-xs text-gray-500 mb-4">Get wellness tips, booking specials, and updates.</p>
      ...
      <div class="mt-8">
        ...
        <div class="flex border-b border-gray-300 pb-1">
          <input type="email" placeholder="Your email..." class="bg-transparent text-sm w-full outline-none placeholder-gray-400" />
  ...
  <div class="max-w-[1200px] mx-auto mt-24 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400">
    <p>© 2024 Nordic Edge Wellness Inc.</p>
